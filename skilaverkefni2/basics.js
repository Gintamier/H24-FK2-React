...
/*
Test cases:
myFunction(1,2) Expected false
myFunction('1','1') Expected true
myFunction()
/*
Test cases:
...
console.log(getFirstChar("Ananas"));
console.log(getFirstChar("qwerty"));
console.log(getFirstChar("QWERTY"));
...
// console.log(getNthChar("string", 4));
// console.log(getNthChar("1234", 1));
// console.log(getNthChar("Ananas", 3));
// console.log(getNthChar("qwerty", 5));
...
// console.log(extractFirstHalfOfString("qwerty"));
...
// console.log(removeLastNChractersOfString("123456"));
...
// console.log(getPercentageOfNumber(900, 10));
